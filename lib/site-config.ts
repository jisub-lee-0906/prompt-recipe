...
export const SITE_DESCRIPTION =
  "기획자, 디자이너, 주니어 개발자가 웹 개발과 UI/UX 용어를 빠르게 이해하고 AI IDE에 더 정확하게 요청하도록 돕는 정적 문서 사이트입니다.";
...
> = {
  "ui-ux": {
    title: "UI/UX",
    description:
      "모달, 토스트, 검색, 피드백처럼 화면 경험을 설명할 때 자주 쓰는 UI/UX 용어를 실무 문맥으로 정리합니다.",
  },
  frontend: {
    title: "프론트엔드",
    description:
      "컴포넌트, 상태, 라우팅, 렌더링처럼 화면 구현에 필요한 핵심 개념을 비개발자도 이해하기 쉽게 풀어냅니다.",
  },
  backend: {
    title: "백엔드",
    description:
      "API, 인증, 권한, 캐시, 운영 개념처럼 서비스 동작과 데이터 흐름을 설명할 때 필요한 용어를 다룹니다.",
  },
};
...
export const ROLE_PATHS = [
  {
    role: "기획자",
    description:
      "기능 요구사항과 사용자 흐름을 개발 언어로 바꿔 AI IDE에 전달하는 감각을 빠르게 익히는 시작 경로입니다.",
    slugs: ["user-flow", "information-architecture", "success-criteria", "api"],
  },
  {
    role: "디자이너",
    description:
      "화면 패턴과 상태 표현, 문구 설계를 AI IDE에 더 구체적으로 요청할 때 도움이 되는 시작 경로입니다.",
    slugs: ["modal", "toast", "empty-state", "microcopy"],
  },
  {
    role: "주니어 개발자",
    description:
      "컴포넌트 구조, 상태, 라우팅, 데이터 흐름을 빠르게 정리하고 구현 감각을 익히는 데 적합한 경로입니다.",
...
export const CHANGELOG_ENTRIES = [
  {
    ...
    summary:
      "UI/UX, 프론트엔드, 백엔드, 기획·협업·품질 축을 포함한 96개 레퍼런스 문서를 모두 기준 문서 수준으로 정리했습니다.",
  },
  {
    date: "2026-03-24",
  ...
  },
  {
    ...
    summary:
      "문서 검색, 메타데이터, 변경 로그, 정적 품질 감사 스크립트를 정리해 제품 완성도를 끌어올렸습니다.",
  },
] as const;
